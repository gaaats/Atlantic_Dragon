...
class SeeecMainnnFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_seeec_mainnn, container, false)
    }
    ...
    private fun tggtjigtjgttgg() {
        findNavController().navigate(R.id.action_seeecMainnnFragment_to_beeffooFillFragment)
    }
}