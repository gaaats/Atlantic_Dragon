...
import com.bimiboo.number.databinding.FragmentGame1Binding
...
class Game1Fragment : Fragment() {
    ...
    private fun gttgjjgtjigtjitgjigt() {
        findNavController().navigate(R.id.action_game1Fragment_to_game2Fragment)
    }

    private var fragmentG1Binding: FragmentGame1Binding? = null
    private val yyyyy
    ...
    override fun onCreateView(
        ...
        fragmentG1Binding = FragmentGame1Binding.inflate(inflater, container, false)
        return yyyyy.root
    }
